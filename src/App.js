...
function App() {
    ...
    const [recorderCount, setRecorderCout] = useState(0);
    useEffect(() => {
    ...
    const jsonData = [
        { "name": "John", "gender": "male", "text": "Hey there! Did you know that I'm writing a novel?", "timestamp": "2024-01-08T12:00:00" },
        { "name": "Alex", "gender": "female", "text": "Oh, really? What's it about?", "timestamp": "2024-01-08T12:05:00" },
        { "name": "John", "gender": "male", "text": "It's a thrilling story about a snail who dreams of becoming a race car driver.", "timestamp": "2024-01-08T12:10:00" },
        { "name": "Alex", "gender": "female", "text": "A snail race car", "timestamp": "2024-01-08T12:05:00" }
    ];
    ...
    return (
        <div className='relative  flex justify-center items-center min-h-screen w-full'>
            ...
            </div>
            {
                ...
                !onlyVideo ? <main className='h-screen flex w-full flex-col relative z-10'>
                    ...
                    <div className="flex w-full space-x-3 p-8 h-screen justify-center">
                        <div className="w-1/3 border rounded bg-white p-4 shadow">
                            ...
                            <textarea value={textArea} onChange={(ev) => setTextArea(ev.target.value)} className="text-sm w-full h-full border rounded bg-gray-200 p-4">
                            </textarea>
                        </div>
                                ...
                                <section id="chatSection" className="border-t-2 border-gray-200 pt-12 h-[600px] overflow-hidden space-y-4">
                                    {
                                        chat.map((item, i) => {
                                            if (i % 2 === 0) {
                                                return <div className="p-2 flex items-start">
                                                ...
                                                return <div className="p-2 flex justify-end items-start">
                    ...
                    <div className="relative z-10 w-[450px] border rounded bg-white flex flex-col justify-center p-2 shadow h-[600px]">
                        {
                            !playVoices ?
                                ...
                                <button className='w-40 h-20 text-2xl bg-green-500 text-white' onClick={onStartConversation}>Play</button>
                                :
                                <button className='w-40 h-20 text-2xl bg-red-500 text-white' onClick={stopRecording}>Stop</button>
                        }
                        <div>
                            <div className="flex items-center space-x-4 p-2">
                                <img className="h-16 w-16 rounded-full" src="./male.jpg" alt="logo" />
